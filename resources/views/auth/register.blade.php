            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="dial_code" class="col-md-4 col-form-label text-md-right">{{ __('Dial Code') }}</label>
                             <div class="col-md-6">
                                <input id="dial_code" type="dial_code" class="form-control @error('dial_code') is-invalid @enderror" name="dial_code" value="{{ old('dial_code') }}" required autocomplete="dial_code">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <?php 
                                    $user_type = ['1'=>'Client','2'=>'Designer'];
                                ?>
                                {!! Form::select('user_type', $user_type, '', ['class' => 'form-control m-bot15']) !!}
